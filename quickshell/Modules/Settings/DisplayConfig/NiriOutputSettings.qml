...
Column {
    ...
    Column {
        ...
        DankToggle {
            ...
            enabled: checked || DisplayConfigState.canDisableOutput(root.outputData, root.outputName)
            description: (!checked && !DisplayConfigState.canDisableOutput(root.outputData, root.outputName)) ? (Object.keys(DisplayConfigState.outputs).length <= 1 ? I18n.tr("Cannot disable the only output") : I18n.tr("At least one output must remain enabled")) : ""
